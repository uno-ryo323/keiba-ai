...
class KeibaAI():
    ...
    def remove_data(data, ai_type):
        ...
        if ai_type == 0:
            columns = ["corner_position1","corner_position2","corner_position3","corner_position4","class_code","grade_code","track_code","track_code2","corner_count",\
                       "course_class","race_prize","rpci","pci3","race_type_code","race_symbol_code","weight_type_code","blinkers","rank_offical","rank_arrival",\
                           "abnormal_code","time_diff","ave_3f","pci","minus_3f"]
    ...
    def make_model():        
        ...
        keiba_data = pd.read_csv("C:\\keibaAI\\Data\\netKeiba\\result\\process\\race_jra+.csv", sep=",", encoding="cp932")
        ...
        filename = 'C:\\keibaAI\\Source\\model\\Win_new.sav'
    ...
    def forecast_race(self,ai_type):
        #modelのインポート(ToDo)
        path = "C:\\keibaAI\\Source\\model\\"
        if ai_type == 0:
           model_ver = "_model2"
        else:
            model_ver = "_3"

        model_filename = 'Win' + model_ver + '.sav'
        model1 = pickle.load(open(path + model_filename, 'rb'))
        model_filename = 'Quinella' + model_ver + '.sav'
        model2 = pickle.load(open(path + model_filename, 'rb'))
        model_filename = 'Place' + model_ver + '.sav'
        #model_filename = 'Place_model3.sav'
        ...
        #result_data.to_csv("C:\\keibaAI\\Data\\netKeiba\\racecard\\" + race_id + "_forecast.csv", sep=",", encoding="shift_jis")
